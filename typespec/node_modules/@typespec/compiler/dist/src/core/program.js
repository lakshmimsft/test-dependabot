...
import { createSourceLoader, loadJsFile } from "./source-loader.js";
...
export async function compile(host, mainFile, options = {}, oldProgram // NOTE: deliberately separate from options to avoid memory leak by chaining all old programs together.
    ...
    async function loadIntrinsicTypes(loader) {
        ...
        return loader.importFile(resolvePath(host.getExecutionRoot(), "lib/intrinsics.tsp"), locationContext);
    }
