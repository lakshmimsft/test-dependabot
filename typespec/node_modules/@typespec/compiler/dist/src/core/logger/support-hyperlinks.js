...
export function supportsHyperlink(stream) {
    const { CI, TERM, TERM_PROGRAM, TERM_PROGRAM_VERSION, VTE_VERSION, FORCE_HYPERLINK, COLORTERM, TERMINAL_EMULATOR, } = process.env;
    if (FORCE_HYPERLINK) {
...
//# sourceMappingURL=support-hyperlinks.js.map