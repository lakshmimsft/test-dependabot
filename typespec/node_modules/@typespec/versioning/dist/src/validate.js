import { NoTarget, getNamespaceFullName, getService, getTypeName, isTemplateInstance, isType, navigateProgram, } from "@typespec/compiler";
import { $added, $removed, findVersionedNamespace, getMadeOptionalOn, getMadeRequiredOn, getRenamedFrom, getReturnTypeChangedFrom, getTypeChangedFrom, getUseDependencies, getVersion, } from "./decorators.js";
import { reportDiagnostic } from "./lib.js";
import { Availability, getAvailabilityMap, getVersionDependencies, getVersions, } from "./versioning.js";
...
function validateTargetVersionCompatible(program, source, target, validateOptions = {}) {
    ...
    if (validateOptions.isTargetADependent) {
        ...
        validateAvailabilityForRef(program, sourceAvailability.map, targetAvailability.map, sourceAvailability.type, targetAvailability.type);
    }
}
