...
import { getHttpOperation, getHttpPart, isMetadata } from "@typespec/http";
...
import { getClientNamespaceStringHelper, getHttpBodySpreadModel, getHttpOperationResponseHeaders, isHttpBodySpread, parseEmitterName, removeVersionsLargerThanExplicitlySpecified, } from "./internal-utils.js";
    ...
    if (root.kind === "Operation") {
        ...
        if (httpOperation.parameters.body) {
            ...
            if (isHttpBodySpread(httpOperation.parameters.body)) {
                bodyType = getHttpBodySpreadModel(context, httpOperation.parameters.body.type);
            }
            else {
 ...
 * @returns
 */
export function listSubClients(client, listNestedClients = false) {
