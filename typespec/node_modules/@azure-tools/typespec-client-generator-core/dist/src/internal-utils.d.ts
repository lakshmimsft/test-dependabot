import { BooleanLiteral, Diagnostic, Interface, Model, ModelProperty, Namespace, NumericLiteral, Operation, Program, StringLiteral, Type, Union } from "@typespec/compiler";
 ...
 * @returns
 */
export declare function getHttpBodySpreadModel(context: TCGCContext, type: Model): Model;
export declare function isOnClient(context: TCGCContext, type: ModelProperty, operation?: Operation): boolean;
export {};
