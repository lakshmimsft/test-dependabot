...
import { SdkClientType, SdkHttpOperationExample, SdkServiceOperation, TCGCContext } from "./interfaces.js";
 ...
 * @returns
 */
export declare function listSubClients<TServiceOperation extends SdkServiceOperation>(client: SdkClientType<TServiceOperation>, listNestedClients?: boolean): SdkClientType<TServiceOperation>[];
