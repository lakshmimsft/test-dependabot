import { DecoratorContext, DecoratorFunction, EmitContext, Enum, Interface, Model, ModelProperty, Namespace, Operation, Program, Type, Union } from "@typespec/compiler";
import { AccessDecorator, ClientDecorator, ClientInitializationDecorator, ClientNameDecorator, ConvenientAPIDecorator, FlattenPropertyDecorator, OperationGroupDecorator, ParamAliasDecorator, ProtocolAPIDecorator, UsageDecorator } from "../generated-defs/Azure.ClientGenerator.Core.js";
import { AccessFlags, LanguageScopes, SdkClient, SdkContext, SdkEmitterOptions, SdkHttpOperation, SdkInitializationType, SdkOperationGroup, SdkServiceOperation, TCGCContext, UsageFlags } from "./interfaces.js";
...
export declare function getAccessOverride(context: TCGCContext, entity: Model | Enum | Operation | Union | Namespace): AccessFlags | undefined;
...
export declare const paramAliasDecorator: ParamAliasDecorator;
