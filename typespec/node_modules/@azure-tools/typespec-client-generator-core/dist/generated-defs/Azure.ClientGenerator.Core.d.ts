import type { DecoratorContext, Enum, EnumMember, Interface, Model, ModelProperty, Namespace, Operation, Type, Union } from "@typespec/compiler";
/**
 ...
 * ```
 */
export type ConvenientAPIDecorator = (context: DecoratorContext, target: Operation, value?: boolean, scope?: string) => void;
/**
 ...
 * ```
 */
export type ProtocolAPIDecorator = (context: DecoratorContext, target: Operation, value?: boolean, scope?: string) => void;
/**
 ...
 *
 */
export type ClientDecorator = (context: DecoratorContext, target: Namespace | Interface, value?: Model, scope?: string) => void;
/**
 ...
 * ```
 */
export type AccessDecorator = (context: DecoratorContext, target: Model | Operation | Enum | Union | Namespace, value: EnumMember, scope?: string) => void;
/**
 ...
 * ```
 */
export type OverrideDecorator = (context: DecoratorContext, original: Operation, override: Operation, scope?: string) => void;
/**
 ...
 * ```
 */
export type ClientInitializationDecorator = (context: DecoratorContext, target: Namespace | Interface, options: Model, scope?: string) => void;
/**
 ...
 * ```
 */
export type ParamAliasDecorator = (context: DecoratorContext, original: ModelProperty, paramAlias: string, scope?: string) => void;
