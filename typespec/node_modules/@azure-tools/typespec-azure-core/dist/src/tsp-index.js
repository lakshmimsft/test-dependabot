import { $armResourceIdentifierConfig, $defaultFinalStateVia, $embeddingVector, $ensureResourceType, $ensureVerb, $finalLocation, $finalOperation, $fixed, $items, $lroCanceled, $lroErrorResult, $lroFailed, $lroResult, $lroStatus, $lroSucceeded, $needsRoute, $nextLink, $nextPageOperation, $omitKeyProperties, $operationLink, $pagedResult, $pollingLocation, $pollingOperation, $pollingOperationParameter, $requestParameter, $responseProperty, $spreadCustomParameters, $spreadCustomResponseProperties, $useFinalStateVia, } from "./decorators.js";
import { $addTraitProperties, $applyTraitOverride, $ensureAllHeaderParams, $ensureAllQueryParams, $ensureTraitsPresent, $trait, $traitAdded, $traitContext, $traitLocation, $traitSource, } from "./traits.js";
